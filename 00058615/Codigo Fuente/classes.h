...
enum parameters {MACRO_T,MACRO_K,MACRO_L,MACRO_PSI_X,MACRO_PSI_Y,MACRO_D,MACRO_E};
...
class mesh{
    ...
    public:
        void setParameters(float condicion_t,float condicion_k, float condicion_l, float condicion_psi_x, float condicion_psi_y, float condicion_d, float condicion_e){
            parameters[MACRO_T]=condicion_t;
            parameters[MACRO_K]=condicion_k;
            parameters[MACRO_L]=condicion_l;
            parameters[MACRO_PSI_X]=condicion_psi_x;
            parameters[MACRO_PSI_Y]=condicion_psi_y;
            parameters[MACRO_D]=condicion_d;
            parameters[MACRO_E]=condicion_e;
        }
