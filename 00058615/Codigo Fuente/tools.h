...
void leerMallayCondiciones(mesh &m,char *filename){
    ...
    ifstream file;
    float condicion_t,condicion_k,condicion_l,condicion_psi_x,condicion_psi_y,condicion_d,condicion_e;
    ...
    file >> condicion_t >> condicion_k >> condicion_l >> condicion_psi_x >> condicion_psi_y >> condicion_d >> condicion_e;
    ...
    m.setParameters(condicion_t,condicion_k,condicion_l,condicion_psi_x,condicion_psi_y,condicion_d,condicion_e);
